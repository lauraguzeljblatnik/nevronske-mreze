...
let input_rows = Csv.sub 1 2 lines 11 csvs

let input1 = Csv.to_array input_rows

let input = matrix_string_to_float input1

let output_rows = Csv.sub 1 13 lines 3 csvs

let output1 = Csv.to_array output_rows 

let out = matrix_string_to_float output1
